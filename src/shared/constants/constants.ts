...
export const ADD_PLAYER_PARTICIPATION = Symbol('ADD_PLAYER_PARTICIPATION');
...
export const CREATE_PLAYER = Symbol('CREATE_PLAYER');
export const CREATE_REPORT = Symbol('CREATE_REPORT');
export const CREATE_GAME = Symbol('CREATE_GAME');
export const CANCEL_GAME = Symbol('CANCEL_GAME');
export const CREATE_USER = Symbol('CREATE_USER');
export const FINISH_GAME = Symbol('FINISH_GAME');
export const JOIN_GAME = Symbol('JOIN_GAME');
