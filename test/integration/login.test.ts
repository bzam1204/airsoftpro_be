...
describe('Entrar', function () {
  ...
  it('Deve entrar no sistema', async function () {
    ...
    const tokenServiceStub = {signAccessToken : () => '123123', signRefreshToken : () => '321321'};
    const login = new Login(fieldAdminRepository, playerRepository, userRepository, hashingServiceStub, tokenServiceStub);
